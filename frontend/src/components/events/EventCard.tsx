        ...
        <div className="p-5 space-y-3">
          <div className="flex justify-between items-start">
            <span
              ...
              } text-white text-[8px] px-2.5 py-1 rounded-full font-black uppercase tracking-[0.2em]`}
            >
              {event.type}
            </span>
          ...
          <div className="pt-2 flex justify-between items-center border-t border-white/5">
            ...
            <button
              type="button"
              className="text-[9px] font-black uppercase tracking-widest bg-white/5 px-3 py-1.5 rounded-lg group-hover:bg-[#f27690] group-hover:text-white transition-all"
            >
              {ctaLabel}
            </button>
          </div>
